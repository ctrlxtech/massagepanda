...
urlpatterns = [
    ...
    url(r'^In-Home_Couples_Massage_for_1_Hour$', DetailsView.as_view(context={'service': Service.objects.get(service_type="Couples Massage", service_time=1)})),
    url(r'^In-Home_Couples_Massage_for_1.5_Hours$', DetailsView.as_view(context={'service': Service.objects.get(service_type="Couples Massage", service_time=1.5)})),
